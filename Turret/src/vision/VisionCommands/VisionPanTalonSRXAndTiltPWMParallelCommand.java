 ...
 *
 */
public class VisionPanTalonSRXAndTiltPWMParallelCommand extends Command {
	...
	public VisionPanTalonSRXAndTiltPWMParallelCommand(VisionMaster VM, VisionController VC, String chose) {
		this.VC = VC;
		this.VM = VM;
